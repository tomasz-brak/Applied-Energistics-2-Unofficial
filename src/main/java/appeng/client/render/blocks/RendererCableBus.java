...
public class RendererCableBus extends BaseBlockRender<BlockCableBus, TileCableBus> {
    ...
    @Override
    public void renderInventory(final BlockCableBus blk, final ItemStack is, final RenderBlocks renderer,
    ...
    @Override
    public void renderTile(final BlockCableBus block, final TileCableBus cableBus, final Tessellator tess,
